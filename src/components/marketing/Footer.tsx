      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 py-14 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="inline-flex items-center gap-2.5 mb-4 group">
              ...
              <span className="font-display font-bold text-lg text-white">NusaBackup</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li>
                <Link href="/kontak" className="text-slate-300 hover:text-white text-sm transition-colors">
                  Kontak
                </Link>
              </li>
            </ul>
            ...
            <ul className="space-y-3">
              {waNumber && (
                <li>
                  ...
                  >
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className="shrink-0 text-green-400" aria-hidden>
              ...
              {email && (
                <li>
                  <a
                    ...
                    className="flex items-center gap-2.5 text-slate-300 hover:text-white text-sm transition-colors"
                  >
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="shrink-0 text-brand-400" aria-hidden>
              ...
              {address && (
                <li className="flex items-start gap-2.5 text-slate-300 text-sm">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="shrink-0 text-slate-400 mt-0.5" aria-hidden>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-slate-500 text-xs">
            &copy; {new Date().getFullYear()} NusaBackup. Seluruh hak dilindungi.
          </p>
          <p className="text-slate-600 text-xs">
            Layanan backup offsite &amp; disaster recovery Indonesia
          </p>
        </div>
      </div>
    </footer>
